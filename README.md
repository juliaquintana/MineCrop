...
**2. Python scripts used for orthogroup analysis after running Orthofinder**

**extract_fasta.py**

Purpose:
Extracts sequences from a FASTA file whose identifiers match a list of provided IDs (partial matches are supported). We use this to generate a fasta file with especic genes of interest.
...
Requirements: Python 3 and Biopython

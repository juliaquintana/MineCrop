...
# Description: This script automatically downloads NCBI SRA reads and stores them in Google Cloud to avoid disk space issues. This script is meant to be executed after installing SRAtoolkit in your computer.
